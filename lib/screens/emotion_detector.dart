// import 'dart:async';
// import 'package:emosift/main.dart';
...
//   String output = '';
//   bool isModelBusy = false; // Add this flag
...
//   //   final selectedCamera = isFrontCamera ? cameras[0] : cameras[1];
...
//         ? cameras[1]
//         : cameras[0]; // Use index 1 for front camera, 0 for back camera
...
//   bool showButton = false; // Add this flag
...
//       // Set the flag to prevent overlapping inferences
//       isModelBusy = true;
...
//         });
//       } catch (e) {
//         // Handle errors or exceptions during inference
//         print('Error running model: $e');
//       } finally {
//         // Reset the flag after inference is complete
//         isModelBusy = false;
//       }
//     }
//   }
...
//                     toggleCamera();
//                   },
//                   child: Text(' ${isFrontCamera ? 'Front' : 'Back'}'),
//                 ),
//               ),
//             ]),
//             Text(
